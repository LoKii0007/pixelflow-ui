        ...
        >
            <AnimatePresence>
                <motion.div
                    ...
                    style={{
                        background:
                            "linear-gradient(145deg, rgba(40,40,45,0.95), rgba(25,25,30,0.98))",
                    }}
                >
                    {/* Icon */}
...
function StatusElevation({ items = [], duration = 0.3 }) {
...
export default function StatusElevationDemo() {
