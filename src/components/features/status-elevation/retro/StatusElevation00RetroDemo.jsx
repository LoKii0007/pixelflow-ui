...
import { StatusElevation00 } from "../StatusElevation00";
...
export function StatusElevation00RetroDemo({
    ...
    return (
        <div className="w-full h-full flex flex-col gap-6 md:p-4">
            ...
            <StatusElevation00 items={items} duration={currentSpeed.duration} variant="retro" />
        </div>
    );
}
