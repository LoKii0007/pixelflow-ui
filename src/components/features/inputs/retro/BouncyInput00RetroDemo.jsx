...
export function BouncyInput00RetroDemo() {
    ...
    return (
        <div className="w-full h-full flex items-center justify-center bg-white p-4">
            <div className="relative w-full max-w-md">
                ...
                <div className="absolute -top-3 left-4 bg-white px-2 text-black border-2 border-black text-xs font-bold uppercase tracking-widest z-20">
                    INPUT_TERMINAL
                </div>
            </div>
        </div>
