  ...
  return (
    <nav className="w-full flex justify-center items-center absolute top-0 z-30 left-0 navbar-wrapper bg-black border-b-[0.6px] border-white/40">
      <div className="px-5 md:px-12 py-5 flex items-center gap-4 justify-between w-full z-20">
        <Link
          href="/components/navbars"
          className="nav-left text-black bg-white px-4 py-2 font-bold text-sm md:text-xl z-20 whitespace-nowrap uppercase"
        >
          PixelFlow <span className="text-gray-500">UI</span>
        </Link>

        <div
          ref={navbarRef}
          className=" z-50 border-white/50 border-[0.6px] p-1 md:p-2 flex items-center gap-2"
        >
          <div className="relative flex items-center gap-2 md:gap-4">
            <div
              ...
              className="absolute pill-bg h-full z-20 transition-all duration-500 bg-white cursor-pointer pointer-events-none"
            ></div>
            ...
            <div className="hidden md:flex items-center gap-2">
              {navItems.map((item, index) => (
                <Link
                  ...
                  key={index}
                  href={item.href}
                  className=" text-white px-5 py-1 cursor-pointer z-30 hover:text-black transition-all duration-500 relative uppercase text-sm font-medium"
            ...
            <div
              onClick={() => toggleNav()}
              className="flex cursor-pointer w-8 h-8 transition-all duration-300 bg-white p-2 hover:scale-125 z-30 items-center justify-center text-black"
            >
      ...
      >
        <div className=" w-full h-full flex flex-col bg-white overflow-hidden relative">
          <div className="w-full h-[80px] md:h-[100px] flex items-center justify-between px-5 md:px-12 py-5 shrink-0">
            <div className="nav-left text-white bg-black px-4 py-2 font-bold text-sm md:text-xl z-40 uppercase">
              PixelFlow <span className="text-gray-400">UI</span>
            </div>

            <div className=" z-50 p-2 flex items-center justify-end">
              <div
                onClick={() => toggleNav()}
                className="flex origin-center bg-black w-8 h-8 md:w-10 md:h-10 transition-all duration-300 justify-center items-center cursor-pointer hover:scale-110 z-50"
              >
          ...
          <div className="relative w-full flex flex-col md:grid md:grid-cols-2 px-5 md:px-12 pb-12 pt-4 flex-1 nav-wrapper overflow-hidden">
            ...
            <div className="right w-full flex items-center md:items-end justify-center md:justify-end h-[200px] md:h-full relative order-1 md:order-2">
              <div className=" flex flex-col justify-center gap-2 text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-black relative select-none uppercase">
...
export default Navbar4LyraCode;
